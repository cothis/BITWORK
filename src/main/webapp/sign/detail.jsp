...
<head>
    ...
    <script>
        ...
        function download(fileName, oriName) {
            location.href=  "/sign/download?fileName=" + fileName + "&oriName=" + oriName;
        }
    </script>
</head>
        ...
        <form class="form-write" action="/sign/detail" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="content"
                          id="content" ${empty requestScope.vo ? "" : "readonly"}>${requestScope.vo.docContent}</textarea>
            </div>
            <div class="form-group">
                <label for="writer"><h3>기안자</h3></label>
                <input type="text" name="writer" id="writer"
                       value="${empty requestScope.vo ? sessionScope.user.name : requestScope.vo.writerName}" readonly>
            ...
            <div class="form-group">
                ...
                <input type="file" name="file" id="file" class="${not empty requestScope.vo ? "display-none" : ""}"> <!-- detail일때는 업로드 되있는 파일명이 보여야 함 -->
            </div>
